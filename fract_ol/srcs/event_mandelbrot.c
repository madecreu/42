...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/05/11 18:49:05 by madecreu          #+#    #+#             */
/*   Updated: 2018/05/11 18:49:07 by madecreu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		event_mandel(int keycode, void *param)
{
	...
	return (event_mandel2(keycode, param));
}
...
int		event_mandel2(int keycode, void *param)
{
	...
	return (event_mandel3(keycode, param));
}
...
int		event_mandel3(int keycode, void *param)
{
	...
	return (event_mandel4(keycode, param));
}
...
int		event_mandel4(int keycode, void *param)
{
	...
	return (event_mandel5(keycode, param));
}
